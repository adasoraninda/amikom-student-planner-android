...
import com.codetron.studentplanner.databinding.ItemTaskVrBinding
import javax.inject.Inject
import javax.inject.Singleton

@Singleton
class TaskVerticalAdapter @Inject constructor() :
    ListAdapter<Task, TaskVerticalAdapter.TaskViewHolder>(DIFF_CALLBACK) {
    ...
    class TaskViewHolder private constructor(private val binding: ItemTaskVrBinding) :
        RecyclerView.ViewHolder(binding.root) {

        companion object {
            fun from(parent: ViewGroup): TaskViewHolder {
                val inflater = LayoutInflater.from(parent.context)
                val binding = ItemTaskVrBinding.inflate(inflater, parent, false)
